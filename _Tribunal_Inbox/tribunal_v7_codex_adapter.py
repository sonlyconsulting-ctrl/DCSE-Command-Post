...
KNOWN_NPM_CODEX_PATH = Path(
    r"C:\Users\dsead\AppData\Roaming\npm\codex.cmd"
)
...
def find_codex_executable() -> str | None:
    ...
    # Prefer the current npm Codex CLI (>= 0.153.0) when installed.
    if KNOWN_NPM_CODEX_PATH.is_file():
        return str(KNOWN_NPM_CODEX_PATH)
