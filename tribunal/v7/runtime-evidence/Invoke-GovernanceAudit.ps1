...
function Get-ZoneFromPath([string]$rel) {
    ...
    elseif ($p -match 'governance/v7\.1/execution/') { return 'execution' }
...
$lines.Add("---")
$lines.Add("*Generated by Invoke-GovernanceAudit.ps1 v1.0 -- DCSE-DCSE-GOV-20260804-GOVERNANCE-AUDIT-001*")
